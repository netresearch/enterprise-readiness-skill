...
| `license_location` | Licence file in the root. Word it neutrally ("the licence text is in the repository root"): the criterion also holds for a licence that is not FLOSS |
