...
| `access_continuity` | Maintain access if contributor unavailable | A second person with 2FA who can also release (registry, signing keys), or keys in a lockbox plus a will |
